<div class="section categories">
      <div class="container">
        <div class="categories__wrapper">
          <h2 class="categories__title section__title">Категории товаров</h2>
          <div class="categories__variety">
            <a href="./catalog.php" class="col-25 categories__item"><i class="categories__icon fas fa-table-tennis"></i>Развлечения, досуг</a>
            <a href="./catalog.php" class="col-25 categories__item"><i class="categories__icon fas fa-wine-glass-alt"></i>Посуда и зеркала</a>
            <a href="./catalog.php" class="col-25 categories__item"><i class="categories__icon fas fa-spray-can"></i>Парфюмерия и косметика</a>
            <a href="./catalog.php" class="col-25 categories__item"><i class="categories__icon fas fa-keyboard"></i>Компьютерная техника</a>

            <a href="./catalog.php" class="col-25 categories__item categories__item-hidden test" data-hidden="1"><i class="categories__icon fas fa-couch"></i>Мебель</a>
            <a href="./catalog.php" class="col-25 categories__item categories__item-hidden test" data-hidden="1"><i class="categories__icon fas fa-glasses"></i>Оптика</a>
